        ...
        <ul class="nav nav-sidebar">
          <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-default">
              ...
              <div class="list-group">
                <a href="./home/songmenu" class="list-group-item">Top 10 Songs</a>
                <a href="./home/albummenu" class="list-group-item">Top 10 Albums</a>
                <a href="./home/singermenu" class="list-group-item">Top 10 Singers</a>
                <a href="./home/top100.menu" class="list-group-item">Top 100 of all Time</a>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-xs-6 col-md-6" style="float:left;">
            <a href="#" data-toggle="modal" data-target="#albuminfo" class="thumbnail">
              <img data-src="holder.js/400x360">
            </a>
          </div>
        </div>
      </div>
